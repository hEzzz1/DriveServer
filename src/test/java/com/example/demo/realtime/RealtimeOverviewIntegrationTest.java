...
class RealtimeOverviewIntegrationTest {
    ...
    void overviewShouldReturnWindowStatsLatestAlertsAndRiskDistribution() throws Exception {
        ...
        saveAlert("ALT-OVERVIEW-001", 1001L, 2001L, 3001L, 11L, 3, "0.91", 0, now.minusMinutes(2));
        saveAlert("ALT-OVERVIEW-002", 1001L, 2002L, 3002L, 12L, 2, "0.72", 1, now.minusMinutes(4));
        saveAlert("ALT-OVERVIEW-003", 1001L, 2003L, 3003L, 13L, 1, "0.43", 3, now.minusMinutes(12));
        ...
        mockMvc.perform(get("/api/v1/realtime/overview")
                ...
                .andExpect(jsonPath("$.data.fleetId").value(1001))
