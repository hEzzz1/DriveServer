...
public record DeviceListItemData(
        ...
        Integer uploadQueueSize,
        OffsetDateTime uploadLastSuccessAt,
        OffsetDateTime uploadLastFailedAt,
        String uploadLastFailureClass,
        String uploadLastErrorMessage,
        OffsetDateTime uploadLastReportAt,
