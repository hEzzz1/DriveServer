...
@RestController
@RequestMapping({"/api/v1/rules", "/api/v1/platform/rules"})
public class RuleController {
    ...
    @GetMapping
    @PreAuthorize("@permissionAuthorizationService.hasPermission(authentication, 'rule.read')")
    ...
    @PostMapping
    @PreAuthorize("@permissionAuthorizationService.hasPermission(authentication, 'rule.manage')")
